  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-bottom: 20px;">
      ...
      <router-link to="/" class="g-text-underline--none--hover">
        <img src="../../../static/imgaes/cw.png" width="30" height="30" class="d-inline-block align-top" alt="">
          Blog for
      </router-link>
      <a href="http://www.madmalls.com" class="g-text-underline--none--hover">Wuwent</a>
      </div>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          <li class="nav-item active">
            <router-link to="/" class="nav-link">博客<span class="sr-only">(current)</span></router-link>
          </li>
          <li class="nav-item">
            <router-link to="/ping" class="nav-link">分享</router-link>
          </li>
          <li class="nav-item">
            <router-link to="/ping" class="nav-link">吐槽</router-link>
          </li>
        </ul>
